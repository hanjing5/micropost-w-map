...
class TagRecord < ActiveRecord::Base
	...
	def self.ignore_parse( string )
		...
		tmp_verbs = ["is","are","am","were","be","has","have","having","had","been","to","from","in","as","isn't","wasn't","weren't","ain't","won't","will","hasn't","haven't","hadn't","did","do","didn't","don't","with"]
		tmp_adverbs = ["should","would","could","can","shouldn't","wouldn't","couldn't","can't","cannot",
		...
		combine = modifiers + tmp_verbs + tmp_adverbs + pronouns
